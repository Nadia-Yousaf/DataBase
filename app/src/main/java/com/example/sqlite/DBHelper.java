...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public boolean deleteCustomer(Customer customerModel){
        SQLiteDatabase db = this.getWritableDatabase();
        long delete= db.delete(CUST_TABLE,CUSTOMER_ID+"=?",new String[]{String.valueOf(customerModel.getId())});
    ...
    public List<Customer> getAllRecords(){
        ...
        if(cursor.moveToFirst())
        {
            do{
                ...
                Customer customerModel=new Customer(custName,custAge,isActive,custId);
